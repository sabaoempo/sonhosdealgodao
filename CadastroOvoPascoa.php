    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2"><br>
                <center><h5>Cadastro de Ovo de Páscoa</h5></center><br><br>
                <center>
                    <form method="POST" action="CadastroOvoPascoa.php" enctype="multipart/form-data">
                	    ...
                	    <input type="number" name="size" placeholder="Tamanho" class="form-control"><br>
...
function registerProduct()
{
	...
	$price = $_POST['price'];
	$size = $_POST['size'];
	$query = "INSERT INTO products (type, name, size, description, price, image) VALUES('2', '$name', '$size', '$description', '$price', '$target_file')";
